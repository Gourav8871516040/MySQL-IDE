...
String uid;
    ...
    private void initComponents() {
        ...
        deldb = new javax.swing.JTextField();
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 90, 140, 30);

        deldb.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jPanel1.add(deldb);
        deldb.setBounds(150, 90, 130, 30);
        ...
        jPanel1.add(cdl);
        cdl.setBounds(430, 130, 91, 30);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mysql/ide/columns.png"))); // NOI18N
        jLabel4.setText("Delete Table");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(210, 40, 160, 30);

        deltb.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jPanel1.add(deltb);
        deltb.setBounds(400, 90, 140, 30);
    ...
    private void cdlMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cdlMouseClicked
        // TODO add your handling code here:
          try {
               ...
               Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/"+(uid+deldb.getText()),"root","root1799@");
               
                
                
                String sq="drop table "+(deltb.getText());   
               PreparedStatement pstm=con.prepareStatement(sq);
               pstm.executeUpdate();
              
                JOptionPane.showMessageDialog(deltb,"Table  Deleted.");
                this.setVisible(false);
   ...
   }catch(Exception e)
   {
     ...
     if(e.toString().substring(0, 50).equals("java.sql.SQLSyntaxErrorException: Unknown database"))
           JOptionPane.showMessageDialog(deltb, "Entered Database Dosen't Exist");
     else  if(e.toString().substring(0, 47).equals("java.sql.SQLSyntaxErrorException: Unknown table"))
           JOptionPane.showMessageDialog(deltb, "Entered Table Dosen't Exist");
   } 
    ...
    private javax.swing.JTextField deldb;
